"""
Configuration de production pour le système de paie Guinée
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='payroll_db'),
        'USER': config('DB_USER', default='payroll_user'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Système de Paie <noreply@votre-domaine.com>')
...
# HTTPS (décommentez si vous utilisez HTTPS)
# SECURE_SSL_REDIRECT = True
# SESSION_COOKIE_SECURE = True
# CSRF_COOKIE_SECURE = True

# CORS (si nécessaire pour l'API)
